...
const Avatar = ({ image, className }: AvatarProps) => {
  ...
  return (
    <div
      ref={component}
      className={clsx("relative h-full select-none w-full", className)}
    >
      <div className="avatar aspect-square overflow-hidden rounded-3xl border-2 border-slate-700 opacity-50">
        <PrismicNextImage
          field={image}
